...
\item Consider the following linear programming problem:
    ...
    \begin{enumerate}
        ...
        {\color{blue} 
            ...
            First we make a table for the initial state.
            \begin{center}
                \begin{tabular}{ l } 
                    $\zeta = x_1 + x_2$ \\
                    \hline
            ...
            Solving the equalities above, we then acquire the slack variables to be
            $$
                \omega_1 = 0,  \omega_2 = 0, \omega_3 = \frac{11}{3}
            $$

            From $\zeta = \frac{10}{3} + \frac{1}{12}w_2 - \frac{1}{3}w_1$, the dual problem variables will be
            $$
                y_1 = - \omega_1 = 
            $$
            ...
            $$
                x_1 = \frac{8}{3}, x_2 = \frac{2}{3}, z = \frac{10}{3}
            $$
            \end{enumerate}
        }

...
\item Consider the following linear programming problem:
    ...
    \begin{enumerate}
        ...
        {\color{blue} 
            ...
            Let $\omega_i$ be the slack variables, and $x_i$ be the variables that we are planning to maximize.
            
            First we make a table for the first iteration.
            \begin{center}
                \begin{tabular}{ l } 
                    $\zeta = x_1 + x_2$ \\
                    \hline
            ...
            \begin{center}
                \begin{tabular}{ l } 
                    ...
                    $\omega_3 = 4 - \frac{1}{2}x_2 - \frac{1}{4}\omega_2$ \\
                \end{tabular}
            \end{center}
            ...
            \begin{center}
                \begin{tabular}{ l } 
                    $\zeta = \frac{10}{3} + \frac{1}{12}\omega_2 - \frac{1}{3}\omega_1$ \\
                    \hline
                    $x_2 = \frac{2}{3} + \frac{1}{6}\omega_2 - \frac{2}{3}\omega_1$ \\
                    $x_1 = \frac{8}{3} - \frac{1}{3}\omega_2 + \frac{1}{3}\omega_1$ \\
                    $\omega_3 = \frac{11}{3} - \frac{1}{3}\omega_2 + \frac{1}{3}\omega_1$ \\
                \end{tabular}
            \end{center}

            From the table above, the values of the slack variables are
            $$
                \omega_1 = 0,  \omega_2 = 0, \omega_3 = \frac{11}{3}
            $$

            At the end of the iteration, we know that $\zeta = \frac{10}{3} + \frac{1}{12}w_2 - \frac{1}{3}w_1$.
            Let the coefficient of $\omega_1$ be $\frac{1}{3}$ and $\omega_2$ be $\frac{1}{12}$.
            Thus 
            \begin{align}
                y_1 &= - \omega_1 \text{'s coefficient} = \frac{1}{3} \\
                y_2 &= - \omega_2 \text{'s coefficient} = - \frac{1}{12} \\
                y_3 &= 0 
            \end{align}

            The variables that we have to maximize
            \begin{align}
                x_1 &= \frac{8}{3} \\ 
                x_2 &= \frac{2}{3} \\ 
                z &= \frac{10}{3}

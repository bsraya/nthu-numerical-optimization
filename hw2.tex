...
\begin{enumerate}
    ...
    {\color{blue}
        ...
        \item
            ...
            Let's substitute $\vec{x}$ with $\vec{z}$. We then have,
            \begin{align}
                A\vec{z} &= \vec{b} \\
                A^T A \vec{z} &= A^T \vec{b} \\
                \begin{bmatrix}4 & 2 & 1 \\ 8 & 4 & 2\end{bmatrix} \begin{bmatrix}4 & 8 \\ 2 & 4 \\ 1 & 2\end{bmatrix} \begin{bmatrix} z_1 \\ z_2 \end{bmatrix} &= \begin{bmatrix}4 & 2 & 1 \\ 8 & 4 & 2\end{bmatrix} \begin{bmatrix}21/4 \\ 0 \\ 0\end{bmatrix} \\
                \begin{bmatrix} 1 & 2 \\ 2 & 4 \end{bmatrix} \begin{bmatrix} z_1 \\ z_2 \end{bmatrix} &= \begin{bmatrix} 1 \\ 2 \end{bmatrix} \\
                z_1 + 2 z_2 = 1
            \end{align}
    
            Then, we can express $z_1$ and $z_2$ as
            \begin{align}
                \vec{z} = \begin{bmatrix} 1-2t \\ t \end{bmatrix}
            \end{align}

            The premise, if $\vec{z}\in \mathbb{R}^2$ is a least square solution for $A\vec{x}=\vec{b}$ then $\vec{z}$ is part of a solution to the larger linear system, holds.
